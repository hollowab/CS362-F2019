...
//Functions to be used in switch statement for Ambassador, mine, baron, tribute, and minion cards.
...
int ambassadorcardEffect(int choice2, int choice1, struct gameState *state, int handPos){
